...
func InitRequestRoot(o *Request, buf []byte, offset flatbuffers.UOffsetT) error {
	n := flatbuffers.GetUOffsetT(buf[offset:])
	o.Init(buf, n+offset)
	if RequestNumFields < o.Table().NumFields() {
		return flatbuffers.ErrTableHasUnknownFields
	}
	return nil
}

func TryGetRootAsRequest(buf []byte, offset flatbuffers.UOffsetT) (*Request, error) {
	x := &Request{}
	return x, InitRequestRoot(x, buf, offset)
}

func GetRootAsRequest(buf []byte, offset flatbuffers.UOffsetT) *Request {
	x := &Request{}
	InitRequestRoot(x, buf, offset)
	return x
}

func TryGetSizePrefixedRootAsRequest(buf []byte, offset flatbuffers.UOffsetT) (*Request, error) {
	x := &Request{}
	return x, InitRequestRoot(x, buf, offset+flatbuffers.SizeUint32)
}

func GetSizePrefixedRootAsRequest(buf []byte, offset flatbuffers.UOffsetT) *Request {
	x := &Request{}
	InitRequestRoot(x, buf, offset+flatbuffers.SizeUint32)
	return x
}
...
func (rcv *Request) TryPlayer(obj *hero.Warrior) (*hero.Warrior, error) {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(4))
	if o != 0 {
		x := rcv._tab.Indirect(o + rcv._tab.Pos)
		if obj == nil {
...
const RequestNumFields = 1

func RequestStart(builder *flatbuffers.Builder) {
	builder.StartObject(RequestNumFields)
}
